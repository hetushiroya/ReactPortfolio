    ...
    return(
        ...
        <div className='container about-page'>
            <div className='text-zone'>
                ...
                <p>
                    I am quietly confident, naturally curuious and perpetually working on improving my chops one design problem at a time. 
                </p>
                <p>
                    If I need to define myself in one sentence that would be a family person, a passionate , a photography enthuasiast, and tech-obsessed!!!
                </p>
            </div>
            ...
            <div className='stage-cube-cont'>
                <div className='cubespinner'>
                    ...
                    <div className='face5'>
                        <FontAwesomeIcon icon={faGitAlt} color='#F06529'></FontAwesomeIcon>
                    </div>
                    <div className='face6'>
                        <FontAwesomeIcon icon={faJsSquare} color='#F06529'></FontAwesomeIcon>
                    </div>
                </div>
            </div>
        </div>
